...
mu2e::WFViewer::WFViewer (fhicl::ParameterSet const & ps): 
  art::EDAnalyzer(ps), 
...
void mu2e::WFViewer::analyze (art::Event const & e) {
...
void mu2e::WFViewer::beginRun(art::Run const &e) { 
...
DEFINE_ART_MODULE(mu2e::WFViewer)
