...
void
ArtdaqTimeTrackerServiceInterface::postEndJob()
{
...
void
ArtdaqTimeTrackerServiceInterface::postSourceConstruction(art::ModuleDescription const& md)
{
  sourceType_ = md.moduleName();
}

void
ArtdaqTimeTrackerServiceInterface::preEventReading(ScheduleContext const sc)
{
...
void
ArtdaqTimeTrackerServiceInterface::postEventReading(Event const& e, ScheduleContext const sc)
{
  auto& d = data_[key(sc.id())];
  d.eventID = e.id();
...
void
ArtdaqTimeTrackerServiceInterface::preEventProcessing(Event const& e [[maybe_unused]],
...
void
ArtdaqTimeTrackerServiceInterface::postEventProcessing(Event const&, ScheduleContext const sc)
{
...
void
ArtdaqTimeTrackerServiceInterface::startTime(ModuleContext const& mc)
{
...
void
ArtdaqTimeTrackerServiceInterface::recordTime(ModuleContext const& mc, std::string const& suffix)
{
...
void
ArtdaqTimeTrackerServiceInterface::logToDestination_(Statistics const& evt,
						     std::vector<Statistics> const& modules)
{
  size_t width{30};
...
//#endif /* mu2eartdaq_ArtModules_ArtdaqTimeTrackerService_h */
