...
# mu2edaq04 removed for now
    ...
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[2]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[3]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[4]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[5]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[6]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[7]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[8]} \
    # --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[9]} \
  ...
  DemoControl.rb ${enableSerial} -s -c $1 \
    ...
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[10]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[11]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[12]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[13]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[14]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[15]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[16]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[17]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[18]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[19]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[20]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[21]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[22]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[23]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[24]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[25]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[26]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[27]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[28]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[29]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[30]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[31]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[32]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[33]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[34]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[35]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[36]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[37]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[38]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[39]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[40]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[41]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[42]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[43]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[44]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[45]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[46]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[47]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[48]} \
