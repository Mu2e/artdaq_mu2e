...
#    --dtc `mu2edaq02.dhcp.fnal.gov`,${MU2EARTDAQ_BR_PORT[0]},0 \
  DemoControl.rb ${enableSerial} -s -c $1 \
    --dtc mu2edaq04.fnal.gov,${MU2EARTDAQ_BR_PORT[0]},0,1 \
    --dtc mu2edaq05.fnal.gov,${MU2EARTDAQ_BR_PORT[1]},1,1 \
    --dtc mu2edaq06.fnal.gov,${MU2EARTDAQ_BR_PORT[2]},2,1 \
    --dtc mu2edaq07.fnal.gov,${MU2EARTDAQ_BR_PORT[3]},3,1 \
    --dtc mu2edaq08.fnal.gov,${MU2EARTDAQ_BR_PORT[4]},4,2 \
