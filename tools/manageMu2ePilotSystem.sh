...
if [[ "$1" == "start" ]]; then summary="PS $1 $2"; fi
  ...
  DemoControl.rb ${enableSerial} -s -c $1 \
    --mu2e mu2edaq03-data,${MU2EARTDAQ_BR_PORT[0]},0,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq04-data,${MU2EARTDAQ_BR_PORT[1]},1,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq05-data,${MU2EARTDAQ_BR_PORT[2]},2,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq06-data,${MU2EARTDAQ_BR_PORT[3]},3,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq07-data,${MU2EARTDAQ_BR_PORT[4]},4,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq08-data,${MU2EARTDAQ_BR_PORT[5]},5,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq10-data,${MU2EARTDAQ_BR_PORT[6]},6,${TRK},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --mu2e mu2edaq11-data,${MU2EARTDAQ_BR_PORT[7]},7,${CAL},${USEFILE},$DTCLIB_SIM_PATH/packets.bin \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[0]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[1]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[2]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[3]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[4]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[5]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[6]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[7]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[10]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[11]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[12]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[13]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[14]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[15]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[16]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[17]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[20]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[21]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[22]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[23]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[24]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[25]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[26]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[27]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[30]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[31]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[32]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[33]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[34]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[35]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[36]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[37]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[40]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[41]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[42]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[43]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[44]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[45]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[46]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[47]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[50]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[51]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[52]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[53]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[54]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[55]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[56]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[57]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[60]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[61]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[62]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[63]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[64]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[65]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[66]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[67]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[70]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[71]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[72]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[73]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[74]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[75]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[76]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[77]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[80]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[81]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[82]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[83]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[84]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[85]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[86]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[87]} \
    --eb mu2edaq03-data,${MU2EARTDAQ_EB_PORT[90]} \
    --eb mu2edaq04-data,${MU2EARTDAQ_EB_PORT[91]} \
    --eb mu2edaq05-data,${MU2EARTDAQ_EB_PORT[92]} \
    --eb mu2edaq06-data,${MU2EARTDAQ_EB_PORT[93]} \
    --eb mu2edaq07-data,${MU2EARTDAQ_EB_PORT[94]} \
    --eb mu2edaq08-data,${MU2EARTDAQ_EB_PORT[95]} \
    --eb mu2edaq10-data,${MU2EARTDAQ_EB_PORT[96]} \
    --eb mu2edaq11-data,${MU2EARTDAQ_EB_PORT[97]} \
