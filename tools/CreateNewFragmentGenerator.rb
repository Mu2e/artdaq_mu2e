...
if ! ENV['MU2EARTDAQ_REPO'] 
  puts "Couldn\'t find MU2EARTDAQ_REPO variable; have you sourced setupMU2EARTDAQ?"
  exit 1
end

basedir = ENV['MU2EARTDAQ_REPO'] 
gendir = basedir + "/mu2e-artdaq/Generators/"
overlaydir = basedir + "/mu2e-artdaq/Overlays/"
...
mu2e-artdaq. However, before doing so, consider (A) editing the source
...
copy of mu2e-artdaq/tools/fcl/driver.fcl which will use your fragment
